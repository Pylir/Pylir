...
func.func @test3(%arg0 : i64) -> (i32, i1) {
...
func.func @test4(%arg0 : i32) -> (i64, i1) {
...
func.func @test5(%arg0 : i64) -> (i64, i1) {
    %0 = py.int.fromInteger %arg0 : i64
    %1, %2 = py.int.toInteger %0 : i64
    return %1, %2 : i64, i1
}
...
func.func @test6(%arg0 : index) -> (i64, i1) {
...
func.func @test7(%arg0 : i64) -> (index, i1) {
    %0 = py.int.fromInteger %arg0 : i64
