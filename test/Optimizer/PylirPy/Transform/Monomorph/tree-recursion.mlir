...
py.func private @"builtins.type.__call__$impl[0]"(%arg0: !py.dynamic, %arg1: !py.dynamic, %arg2: !py.dynamic, %arg3: !py.dynamic) -> !py.dynamic {
  ...
  %10 = tuple_len %arg2
  %11 = int_fromUnsigned %10
  %12 = dict_len %arg3
  %13 = int_fromUnsigned %12
  %14 = int_cmp eq %11, %2
  %15 = bool_fromI1 %14
  %16 = int_cmp eq %13, %3
  %17 = bool_fromI1 %16
...
^bb6:  // pred: ^bb5
  %35 = tuple_getItem %arg2[%c0]
  %36 = typeOf %35
  return %36 : !py.dynamic
^bb7:  // pred: ^bb5
  %37 = type_mro %arg1
  %result = mroLookup %c0 in %37
  %40 = tuple_prepend %arg1, %arg2
  %41 = function_call %result(%result, %40, %arg3)
  %42 = typeOf %41
  %43 = type_mro %42
  %44 = tuple_contains %arg1 in %43
  %45 = test.random
...
^bb9:  // pred: ^bb7
  ...
  %48 = tuple_prepend %41, %arg2
  %49 = function_call %result_0(%result_0, %48, %arg3)
  %50 = is %49, %1
  %51 = test.random
