...
// CHECK-NEXT: %[[LHS_BUFFER:.*]] = llvm.getelementptr %[[LHS]][%[[ZERO]], 1]
// CHECK-NEXT: %[[ZERO:.*]] = llvm.mlir.constant(0 : i{{[0-9]+}})
// CHECK-NEXT: %[[RHS_BUFFER:.*]] = llvm.getelementptr %[[RHS]][%[[ZERO]], 1]
// CHECK-NEXT: %[[ZERO:.*]] = llvm.mlir.constant(0 : i{{[0-9]+}})
// CHECK-NEXT: %[[GEP:.*]] = llvm.getelementptr %[[LHS_BUFFER]][%[[ZERO]], 0]
// CHECK-NEXT: %[[LHS_LEN:.*]] = llvm.load %[[GEP]]
// CHECK-NEXT: %[[ZERO:.*]] = llvm.mlir.constant(0 : i{{[0-9]+}})
// CHECK-NEXT: %[[GEP:.*]] = llvm.getelementptr %[[RHS_BUFFER]][%[[ZERO]], 0]
...
// CHECK-NEXT: %[[ZERO:.*]] = llvm.mlir.constant(0 : i{{[0-9]+}})
// CHECK-NEXT: %[[GEP:.*]] = llvm.getelementptr %[[LHS_BUFFER]][%[[ZERO]], 2]
// CHECK-NEXT: %[[LHS_CHAR:.*]] = llvm.load %[[GEP]]
// CHECK-NEXT: %[[ZERO:.*]] = llvm.mlir.constant(0 : i{{[0-9]+}})
// CHECK-NEXT: %[[GEP:.*]] = llvm.getelementptr %[[RHS_BUFFER]][%[[ZERO]], 2]
