...
// CHECK-LABEL: pyHIR.global_func @test(
// CHECK-SAME: %{{[[:alnum:]]+}},
...
pyHIR.global_func @test(%arg0, *%arg1, %arg2 "keyword", %arg3 { test.name = 0 : i32 }) -> !py.dynamic {
...
// CHECK-LABEL: pyHIR.global_func @res_attr()
// CHECK-SAME: -> (!py.dynamic {test.name = 0 : i32})
pyHIR.global_func @res_attr() -> (!py.dynamic { test.name = 0 : i32 }) {
