...
pylir::LinkerInvocationBuilder& pylir::LinkerInvocationBuilder::addEmulation(const llvm::Triple& triple)
{
    PYLIR_ASSERT(m_linkerStyle == LinkerStyle::ELF || m_linkerStyle == LinkerStyle::MinGW);
...
pylir::LinkerInvocationBuilder& pylir::LinkerInvocationBuilder::addLLVMOptions(llvm::ArrayRef<std::string> options)
{
...
pylir::LinkerInvocationBuilder& pylir::LinkerInvocationBuilder::addLibrarySearchDir(llvm::Twine directory)
{
    switch (m_linkerStyle)
    {
...
pylir::LinkerInvocationBuilder& pylir::LinkerInvocationBuilder::addOutputFile(llvm::Twine outputFile)
{
    switch (m_linkerStyle)
    {
...
pylir::LinkerInvocationBuilder& pylir::LinkerInvocationBuilder::addLibrary(llvm::Twine library)
{
    switch (m_linkerStyle)
    {
        case LinkerStyle::MSVC:
