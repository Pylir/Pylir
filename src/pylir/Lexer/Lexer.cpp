...
constexpr llvm::sys::UnicodeCharRange legalIdentifiers[] = {
    ...
    {0x300, 0x374},     {0x376, 0x377},     {0x37b, 0x37d},     {0x37f, 0x37f},     {0x386, 0x386},
    ...
    {0x840, 0x85b},     {0x860, 0x86a},     {0x8a0, 0x8b4},     {0x8b6, 0x8bd},     {0x8d3, 0x8e1},
    ...
    {0xb3c, 0xb44},     {0xb47, 0xb48},     {0xb4b, 0xb4d},     {0xb56, 0xb57},     {0xb5c, 0xb5d},
    ...
    {0x1810, 0x1819},   {0x1820, 0x1878},   {0x1880, 0x18aa},   {0x18b0, 0x18f5},   {0x1900, 0x191e},
    {0x1920, 0x192b},   {0x1930, 0x193b},   {0x1946, 0x196d},   {0x1970, 0x1974},   {0x1980, 0x19ab},
    {0x19b0, 0x19c9},   {0x19d0, 0x19d9},   {0x1a00, 0x1a1b},   {0x1a20, 0x1a5e},   {0x1a60, 0x1a7c},
    {0x1a7f, 0x1a89},   {0x1a90, 0x1a99},   {0x1aa7, 0x1aa7},   {0x1ab0, 0x1abd},   {0x1b00, 0x1b4b},
    ...
    {0x1cd4, 0x1cfa},   {0x1d00, 0x1df9},   {0x1dfb, 0x1f15},   {0x1f18, 0x1f1d},   {0x1f20, 0x1f45},
    ...
    {0x2145, 0x2149},   {0x214e, 0x214e},   {0x2160, 0x2188},   {0x2c00, 0x2c2e},   {0x2c30, 0x2c5e},
    {0x2c60, 0x2ce4},   {0x2ceb, 0x2cf3},   {0x2d00, 0x2d25},   {0x2d27, 0x2d27},   {0x2d2d, 0x2d2d},
    ...
    {0x2dd8, 0x2dde},   {0x2de0, 0x2dff},   {0x2e2f, 0x2e2f},   {0x3005, 0x3007},   {0x3021, 0x302f},
    {0x3031, 0x3035},   {0x3038, 0x303c},   {0x3041, 0x3096},   {0x3099, 0x309a},   {0x309d, 0x309f},
    {0x30a1, 0x30fa},   {0x30fc, 0x30ff},   {0x3105, 0x312f},   {0x3131, 0x318e},   {0x31a0, 0x31ba},
    {0x31f0, 0x31ff},   {0x3400, 0x4db5},   {0x4e00, 0x9fef},   {0xa000, 0xa48c},   {0xa4d0, 0xa4fd},
    {0xa500, 0xa60c},   {0xa610, 0xa62b},   {0xa640, 0xa66f},   {0xa674, 0xa67d},   {0xa67f, 0xa6f1},
    {0xa717, 0xa71f},   {0xa722, 0xa788},   {0xa78b, 0xa7bf},   {0xa7c2, 0xa7c6},   {0xa7f7, 0xa827},
    ...
    {0xab5c, 0xab67},   {0xab70, 0xabea},   {0xabec, 0xabed},   {0xabf0, 0xabf9},   {0xac00, 0xd7a3},
    ...
    {0x10f00, 0x10f1c}, {0x10f27, 0x10f27}, {0x10f30, 0x10f50}, {0x10fe0, 0x10ff6}, {0x11000, 0x11046},
    {0x11066, 0x1106f}, {0x1107f, 0x110ba}, {0x110d0, 0x110e8}, {0x110f0, 0x110f9}, {0x11100, 0x11134},
    {0x11136, 0x1113f}, {0x11144, 0x11146}, {0x11150, 0x11173}, {0x11176, 0x11176}, {0x11180, 0x111c4},
    {0x111c9, 0x111cc}, {0x111d0, 0x111da}, {0x111dc, 0x111dc}, {0x11200, 0x11211}, {0x11213, 0x11237},
    ...
    {0x1135d, 0x11363}, {0x11366, 0x1136c}, {0x11370, 0x11374}, {0x11400, 0x1144a}, {0x11450, 0x11459},
    {0x1145e, 0x1145f}, {0x11480, 0x114c5}, {0x114c7, 0x114c7}, {0x114d0, 0x114d9}, {0x11580, 0x115b5},
    {0x115b8, 0x115c0}, {0x115d8, 0x115dd}, {0x11600, 0x11640}, {0x11644, 0x11644}, {0x11650, 0x11659},
    {0x11680, 0x116b8}, {0x116c0, 0x116c9}, {0x11700, 0x1171a}, {0x1171d, 0x1172b}, {0x11730, 0x11739},
    {0x11800, 0x1183a}, {0x118a0, 0x118e9}, {0x118ff, 0x118ff}, {0x119a0, 0x119a7}, {0x119aa, 0x119d7},
    {0x119da, 0x119e1}, {0x119e3, 0x119e4}, {0x11a00, 0x11a3e}, {0x11a47, 0x11a47}, {0x11a50, 0x11a99},
    {0x11a9d, 0x11a9d}, {0x11ac0, 0x11af8}, {0x11c00, 0x11c08}, {0x11c0a, 0x11c36}, {0x11c38, 0x11c40},
    ...
    {0x11d93, 0x11d98}, {0x11da0, 0x11da9}, {0x11ee0, 0x11ef6}, {0x12000, 0x12399}, {0x12400, 0x1246e},
    {0x12480, 0x12543}, {0x13000, 0x1342e}, {0x14400, 0x14646}, {0x16800, 0x16a38}, {0x16a40, 0x16a5e},
    {0x16a60, 0x16a69}, {0x16ad0, 0x16aed}, {0x16af0, 0x16af4}, {0x16b00, 0x16b36}, {0x16b40, 0x16b43},
    {0x16b50, 0x16b59}, {0x16b63, 0x16b77}, {0x16b7d, 0x16b8f}, {0x16e40, 0x16e7f}, {0x16f00, 0x16f4a},
    {0x16f4f, 0x16f87}, {0x16f8f, 0x16f9f}, {0x16fe0, 0x16fe1}, {0x16fe3, 0x16fe3}, {0x17000, 0x187f7},
    ...
    {0x1e01b, 0x1e021}, {0x1e023, 0x1e024}, {0x1e026, 0x1e02a}, {0x1e100, 0x1e12c}, {0x1e130, 0x1e13d},
    {0x1e140, 0x1e149}, {0x1e14e, 0x1e14e}, {0x1e2c0, 0x1e2f9}, {0x1e800, 0x1e8c4}, {0x1e8d0, 0x1e8d6},
...
{
    return tokens.empty() || tokens.back().getTokenType() == pylir::TokenType::Newline;
}
