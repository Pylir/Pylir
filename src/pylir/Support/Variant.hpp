...
{
    PYLIR_ASSERT(!variant.valueless_by_exception() && std::holds_alternative<T>(variant));
                                   ...
                                   std::enable_if_t<(i == 0 || i > 12)>* = nullptr)
{
    if (variant.index() == i)
    {
        return std::forward<Callable>(callable)(pylir::get<i>(std::forward<Variant>(variant)));
    }
    if constexpr (i != 0)
    {
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 1)>* = nullptr)
{
    ...
    {
        case 0: return std::forward<Callable>(callable)(pylir::get<0>(std::forward<Variant>(variant)));
        case 1: return std::forward<Callable>(callable)(pylir::get<1>(std::forward<Variant>(variant)));
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 2)>* = nullptr)
{
    switch (variant.index())
    {
        case 0: return std::forward<Callable>(callable)(pylir::get<0>(std::forward<Variant>(variant)));
        case 1: return std::forward<Callable>(callable)(pylir::get<1>(std::forward<Variant>(variant)));
        case 2: return std::forward<Callable>(callable)(pylir::get<2>(std::forward<Variant>(variant)));
        default: PYLIR_UNREACHABLE;
    }
}
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 3)>* = nullptr)
{
    switch (variant.index())
    {
        ...
        case 1: return std::forward<Callable>(callable)(pylir::get<1>(std::forward<Variant>(variant)));
        case 2: return std::forward<Callable>(callable)(pylir::get<2>(std::forward<Variant>(variant)));
        case 3: return std::forward<Callable>(callable)(pylir::get<3>(std::forward<Variant>(variant)));
        default: PYLIR_UNREACHABLE;
    }
}
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 4)>* = nullptr)
{
    switch (variant.index())
    {
        ...
        case 2: return std::forward<Callable>(callable)(pylir::get<2>(std::forward<Variant>(variant)));
        case 3: return std::forward<Callable>(callable)(pylir::get<3>(std::forward<Variant>(variant)));
        case 4: return std::forward<Callable>(callable)(pylir::get<4>(std::forward<Variant>(variant)));
        default: PYLIR_UNREACHABLE;
    }
}
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 5)>* = nullptr)
{
    switch (variant.index())
    {
        ...
        case 3: return std::forward<Callable>(callable)(pylir::get<3>(std::forward<Variant>(variant)));
        case 4: return std::forward<Callable>(callable)(pylir::get<4>(std::forward<Variant>(variant)));
        case 5: return std::forward<Callable>(callable)(pylir::get<5>(std::forward<Variant>(variant)));
        default: PYLIR_UNREACHABLE;
    }
}
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 6)>* = nullptr)
{
    switch (variant.index())
    {
        ...
        case 4: return std::forward<Callable>(callable)(pylir::get<4>(std::forward<Variant>(variant)));
        case 5: return std::forward<Callable>(callable)(pylir::get<5>(std::forward<Variant>(variant)));
        case 6: return std::forward<Callable>(callable)(pylir::get<6>(std::forward<Variant>(variant)));
        default: PYLIR_UNREACHABLE;
    }
}
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 7)>* = nullptr)
{
    switch (variant.index())
    {
        ...
        case 5: return std::forward<Callable>(callable)(pylir::get<5>(std::forward<Variant>(variant)));
        case 6: return std::forward<Callable>(callable)(pylir::get<6>(std::forward<Variant>(variant)));
        case 7: return std::forward<Callable>(callable)(pylir::get<7>(std::forward<Variant>(variant)));
        default: PYLIR_UNREACHABLE;
    }
}
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 8)>* = nullptr)
{
    switch (variant.index())
    {
        ...
        case 6: return std::forward<Callable>(callable)(pylir::get<6>(std::forward<Variant>(variant)));
        case 7: return std::forward<Callable>(callable)(pylir::get<7>(std::forward<Variant>(variant)));
        case 8: return std::forward<Callable>(callable)(pylir::get<8>(std::forward<Variant>(variant)));
        default: PYLIR_UNREACHABLE;
    }
}
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 9)>* = nullptr)
{
    switch (variant.index())
    {
        ...
        case 7: return std::forward<Callable>(callable)(pylir::get<7>(std::forward<Variant>(variant)));
        case 8: return std::forward<Callable>(callable)(pylir::get<8>(std::forward<Variant>(variant)));
        case 9: return std::forward<Callable>(callable)(pylir::get<9>(std::forward<Variant>(variant)));
        default: PYLIR_UNREACHABLE;
    }
}
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 10)>* = nullptr)
{
    switch (variant.index())
    {
        ...
        case 8: return std::forward<Callable>(callable)(pylir::get<8>(std::forward<Variant>(variant)));
        case 9: return std::forward<Callable>(callable)(pylir::get<9>(std::forward<Variant>(variant)));
        case 10: return std::forward<Callable>(callable)(pylir::get<10>(std::forward<Variant>(variant)));
        default: PYLIR_UNREACHABLE;
    }
}
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 11)>* = nullptr)
{
    switch (variant.index())
    {
        ...
        case 9: return std::forward<Callable>(callable)(pylir::get<9>(std::forward<Variant>(variant)));
        case 10: return std::forward<Callable>(callable)(pylir::get<10>(std::forward<Variant>(variant)));
        case 11: return std::forward<Callable>(callable)(pylir::get<11>(std::forward<Variant>(variant)));
        default: PYLIR_UNREACHABLE;
    }
}
...
constexpr decltype(auto) visitImpl(Callable&& callable, Variant&& variant, std::enable_if_t<(i == 12)>* = nullptr)
{
    switch (variant.index())
    {
        ...
        case 10: return std::forward<Callable>(callable)(pylir::get<10>(std::forward<Variant>(variant)));
        case 11: return std::forward<Callable>(callable)(pylir::get<11>(std::forward<Variant>(variant)));
        case 12: return std::forward<Callable>(callable)(pylir::get<12>(std::forward<Variant>(variant)));
        default: PYLIR_UNREACHABLE;
    }
}
