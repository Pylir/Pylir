...
struct CondBranchOpConditionalBranchInterface
    : public pylir::ConditionalBranchInterface::ExternalModel<CondBranchOpConditionalBranchInterface,
                                                              mlir::cf::CondBranchOp>
{
    llvm::SmallVector<std::pair<mlir::Block*, mlir::Attribute>> getBranchImplications(mlir::Operation* op) const
    {
...
struct ArithImplicationPatterns : public pylir::DialectImplicationPatternsInterface
{
        ...
        llvm::function_ref<void(mlir::Value, mlir::Attribute)> implicationAddCallback) const override
    {
        ...
        if (mlir::matchPattern(conditional,
                               mlir::m_Op<mlir::arith::XOrIOp>(mlir::matchers::m_Any(&notOperand), mlir::m_One())))
        {
            implicationAddCallback(notOperand, mlir::BoolAttr::get(getContext(), !boolAttr.getValue()));
            return;
        }
    ...
    registry.addExtension(+[](mlir::MLIRContext*, mlir::cf::ControlFlowDialect* dialect)
                          {
                              ...
                              mlir::cf::CondBranchOp::attachInterface<CondBranchOpConditionalBranchInterface>(
                                  *dialect->getContext());
                          });
