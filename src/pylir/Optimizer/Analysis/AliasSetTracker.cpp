...
pylir::AliasSetTracker::AliasSetTracker(mlir::AliasAnalysis& aliasAnalysis) : m_aliasAnalysis(aliasAnalysis) {}
...
mlir::AliasResult pylir::AliasSet::isCorrespondingPartition(mlir::Value value, mlir::AliasAnalysis& aliasAnalysis) const
{
    switch (m_kind)
    {
